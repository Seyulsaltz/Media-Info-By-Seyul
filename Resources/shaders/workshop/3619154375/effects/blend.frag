...
uniform sampler2D g_Texture7; // {"combo":"OPACITYMASK","default":"util/white","label":"ui_editor_properties_opacity_mask","mode":"opacitymask","paintdefaultcolor":"0 0 0 1"}
uniform sampler2D g_Texture1; // {"default":"util/white","label":"ui_editor_properties_blend_texture","mode":"rgbmask"}

#if NUMBLENDTEXTURES >= 2
uniform sampler2D g_Texture2; // {"default":"util/white","label":"ui_editor_properties_blend_texture","mode":"rgbmask"}
#endif

#if NUMBLENDTEXTURES >= 3
uniform sampler2D g_Texture3; // {"default":"util/white","label":"ui_editor_properties_blend_texture","mode":"rgbmask"}
#endif

#if NUMBLENDTEXTURES >= 4
uniform sampler2D g_Texture4; // {"default":"util/white","label":"ui_editor_properties_blend_texture","mode":"rgbmask"}
#endif

#if NUMBLENDTEXTURES >= 5
uniform sampler2D g_Texture5; // {"default":"util/white","label":"ui_editor_properties_blend_texture","mode":"rgbmask"}
#endif

#if NUMBLENDTEXTURES >= 6
uniform sampler2D g_Texture6; // {"default":"util/white","label":"ui_editor_properties_blend_texture","mode":"rgbmask"}
#endif
